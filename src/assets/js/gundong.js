  ...
  var b = {
    init: function (e) {
      ...
      return this.each(function () {
        ...
        m.wrapInner('<div class=\'mCustomScrollBox mCS-' + e.theme + '\' id=\'mCSB_' + c(document).data('mCustomScrollbar-index') + '\' style=\'position:relative; height:100%; overflow:hidden; width:100%;\' />').addClass('mCustomScrollbar _mCS_' + c(document).data('mCustomScrollbar-index'))
      ...
      if (!k.data('bindEvent_scrollbar_drag')) {
        ...
        if (c.support.msPointer) {
          ...
          j.bind('mousedown touchstart', function (H) {
            ...
            H.preventDefault()
            H.stopImmediatePropagation()
            var K = H.originalEvent.touches[0] || H.originalEvent.changedTouches[0], G = c(this), J = G.offset(),
              F = K.pageX - J.left, I = K.pageY - J.top
            D(n, o, I, F)
          })
    ...
    scrollTo: function (e, f) {
      var i = c(this), o = {
        ...
        r = g.children('.mCSB_scrollTools'), j = r.children('.mCSB_draggerContainer'), h = j.children('.mCSB_dragger'),
        t = draggerSpeed = f.scrollInertia, q, s, m, l
...
(function ($) {
  $(window).load(function () {
    $('.anlipic').mCustomScrollbar({
      horizontalScroll: true
    })

    $('.tag_right').mCustomScrollbar()
    $('.sergnwz').mCustomScrollbar()
  })
})(jQuery)
