...
export declare type EmojiInstance = InstanceType<typeof emojiVue>;
export declare const UEmoji: import('../../util').SFCWithInstall<import("vue").DefineComponent<{
    emoji: {
        type: null;
        required: true;
    };
    ...
    emojiList: import("./interface").Emoji[];
    faceList: string[];
