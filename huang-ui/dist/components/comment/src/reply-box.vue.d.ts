declare const _sfc_main: import("vue").DefineComponent<{
    ...
    replyPage: (parentId: string, pageNum: number, pageSize: number, finish: (comments: import('../../../index').CommentApi[]) => void) => void;
    showSize: number;
    page: boolean;
    ...
    ContentBox: import("vue").DefineComponent<{
        ...
        CommentBox: import("vue").DefineComponent<{
            ...
            submit: (obj: import('../../../index').CommentSubmitParam) => void;
